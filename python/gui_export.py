...
from PyQt5.QtWidgets import (QApplication, QWidget, QDesktopWidget, QWizard, QWizardPage, QProgressBar, QComboBox,
                             QHBoxLayout, QVBoxLayout, QGridLayout, QLabel, QLayout, QMessageBox, QSizePolicy)
...
class PageSelectAudiobook(QWizardPage):
    ...
    def __init__(self, wizard, config: Config, font: QFont, logger=None):
        ...
        self.library.filterKnownCheckbox.stateChanged.connect(self.filterKnownChanged)
        self.library.exportButton.setVisible(False)
    ...
    def filterKnownChanged(self, state):

        self.library.filter.invalidate()
